---
title: "TypeLate Documentation"
titleZh: "TypeLate 文件"
description: "Everything you need to install, configure, and master TypeLate."
descriptionZh: "安裝、設定、與深入使用 TypeLate 的完整指南。"
order: 0
---
...
- File an issue or check existing ones on [GitHub](https://github.com/bobo52310/TypeLate/issues).
- Vote on or suggest features at [Wishlist](/wishlist).
- TypeLate is MIT-licensed — read the source, fork it, send a PR.

</div>
<div class="lang-zh">

- 到 [GitHub Issues](https://github.com/bobo52310/TypeLate/issues) 回報問題或查找解答。
- 到 [Wishlist](/wishlist) 投票或提交新功能建議。
- TypeLate 採 MIT 授權 — 歡迎讀原始碼、Fork、送 PR。
